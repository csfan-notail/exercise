...
typedef union{
	int  error_number;
	struct{
		unsigned short  ipv4_error_number;
		unsigned short  ipv6_error_number;
	}ipv4v6_error_number;
} error_number_t;
...
typedef enum
{
  ...
  QMI_WDS_IPV4V6_TYPE = 0x10  //added by qiao to extern, qulcomm not support.
} qmi_wds_ip_family;
...
typedef struct ndis_ipinfo_t
{
	int  i32status_ipv4;   //CONNECTING, CONNECTED,DISCONNECTED
	int  i32status_ipv6;   //CONNECTING, CONNECTED,DISCONNECTED
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_get_lib_version(int ndis_fd, char* version, int i32len);
/********************************************************************
 *
 *         Name:  ndis_connect
 ...
 *        Notes:  
 ********************************************************************/
extern int extern_ndis_connect(int ndis_fd, char *apn, char *username, char *passwd, int auth,int ip_family);			
/********************************************************************
 *
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_qmi_disconnect(int ndis_fd,int ip_family);
/********************************************************************
 *
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_get_status(int ndis_fd, ndis_ipinfo *pipinfo);
/********************************************************************
 *
 *         Name:  ndis_open
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_close(int ndis_fd);
/********************************************************************
 *
 ...
 *        Notes:  
 ********************************************************************/
extern unsigned short ndis_qmi_connect(int ndis_fd, char *apn, char *username, char *passwd, int auth,int ip_family);
/********************************************************************
 *
 *         Name:  ndis_go_active
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_go_active(int ndis_fd);
/********************************************************************
 *
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_get_clientID(int ndis_fd);
 /********************************************************************
 *
 *         Name:  ndis_exit
 *  Description:  ndis dail close
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_exit(int ndis_fd);
/********************************************************************
 *
 *         Name:  ndis_re_open
 *  Description:  open ndis dail port.
 ...
 *        Notes:  
 ********************************************************************/
extern int ndis_re_open(int ndis_fd);
#endif
