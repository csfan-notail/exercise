...
static LTE_RET_E zte_micro_b57_5_pin_state (void *pvData, char *pcBuf)
{
    int iRet = 0; 
    char acCiev[] = "+CPIN:";
...
static LTE_RET_E zte_micro_b57_5_pin_switch (void *pvData, char *pcBuf)
{
...
static LTE_RET_E zte_micro_b57_5_pin_sw_get( void *pvData, char *pcBuf )
{
    int iRet = 0; 
    int iATExeCount = 0;
    int iFlag = 0;
...
static LTE_RET_E zte_micro_b57_5_pin_unlock (void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_pin_alter (void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_power_on (void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
    int iFd = 0;
    ...
    if(NULL != strstr(pcBuf, "+ZICCID:"))
    {
        LTE_LOG(LTE_LOG_INFO, "%d,%s:poweron: write iccid to file!",__LINE__,__func__);
        iFd = open(ICCID_FILE_PATH, O_CREAT|O_WRONLY);
        if (iFd < 0)
        {
            LTE_LOG(LTE_LOG_ERR,"%d,%s,open file fail\n",__LINE__,__func__);
            return LTE_FAIL;
        }
        if(write(iFd,pcBuf,strlen(pcBuf)) < 0)
        {
            LTE_LOG(LTE_LOG_ERR,"%d,%s,write file fail\n",__LINE__,__func__);
            close(iFd);
            return LTE_FAIL;
        }
        close(iFd);
...
static LTE_RET_E zte_micro_b57_5_power_off (void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";

    if(NULL != strstr(pcBuf, acCiev))
    {
        g_stLteStateInfo.iSimRandStaticFlag = 0;
...
static LTE_RET_E zte_micro_b57_5_nettype_set (void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_nettype_get(void *pvData, char *pcBuf)
{
    int iRet = 0;
    FILE *pstFd = NULL;
    char acBuff[512];
...
static LTE_RET_E zte_micro_b57_5_network_prepare(void *pvData, char *pcBuf)
{
...
static LTE_RET_E zte_micro_b57_5_network_status_get(void *pvData, char *pcBuf)
{
    char acNeedleCgreg[16] = "+CGREG";
    char acNeedleCereg[16] = "+CEREG";   
    char acNeedleCreg[16] = "+CREG";  
...
static LTE_RET_E zte_micro_b57_5_connect(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_disconnect(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_signal_get (void *pvData, char *pcBuf)
{
    char acBuffTmp[32] = {0};
    char *pcTmp = NULL;
    char acCiev[] = "+CSQ:";
...
static LTE_RET_E zte_micro_b57_5_imei_get (void *pvData, char *pcBuf)
{
    int iRet = 0;
    FILE *pstFd = NULL;
    char acBuff[512];
...
static LTE_RET_E zte_micro_b57_5_imsi_get(void *pvData, char *pcBuf)
{
    int iRet = 0;
    int iLinkState = 0;
    char acBuffTmp[64];
...
static LTE_RET_E zte_micro_b57_5_simstate_get(void *pvData, char *pcBuf)
{
	int iRet = 0; 
    char acTmp[32] = {0};
    char acCiev[] = "^SYSINFO:";
...
static LTE_RET_E zte_micro_b57_5_oper_info_get(void *pvData, char *pcBuf)
{
    int iRet = 0;
    char acCiev[] = "+COPS:";
    char acOkCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_sms_cent_code_set(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_sms_mode_set(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_sms_func_init(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_sms_recv(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
    int  iFd = 0;
    int  iWriteLen = 0;
...
static LTE_RET_E zte_micro_b57_5_sms_send(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_sms_dele(void *pvData, char *pcBuf)
{
    char acCiev[] = "OK";
...
static LTE_RET_E zte_micro_b57_5_sms_sup_func(void *pvData, char *pcBuf)
{
    int flag = 0;
...
static LTE_RET_E zte_micro_b57_n_ver_get(void *pvData, char *pcBuf)
{
    int iRet = 0;
    char acCiev[] = "B57_"; /* 模块版本号带的前缀 */
    char acCiev1[] = "+CGMR:"; /* 模块版本号带的前缀 */
    char acCiev2[] = "LCC_"; /* 模块版本号带的前缀 */
    char acVersion[64] = {0};
    char *pcTmp = NULL;
    ...
    if(NULL != (pcTmp = strstr(pcBuf, acCiev)))
    {
        ...
        /* 将获取到的lte版本记录下来，供其他接口使用 */
        strncpy(g_acVersion, acVersion, sizeof(g_acVersion));
        if(NULL != strstr(acVersion, ZTE_B57_5_FLAG))
        {
            pstVersion->iVersionIndex = LTE_ZTE_MICRO_B57_5;
        }
        else if(NULL != strstr(acVersion, ZTE_B57_1_FLAG))
        {
            pstVersion->iVersionIndex = LTE_ZTE_MICRO_B57_1;
        }
        else
        {
    ...
    else if(NULL != (pcTmp = strstr(pcBuf, acCiev1)))
    {
        sscanf(pcTmp, "%*[^:]:%s", acVersion);
        strncpy(pstVersion->acVersion, acVersion, sizeof(pstVersion->acVersion));
        if(NULL != strstr(acVersion, ZTE_B78_FLAG))
        {
            pstVersion->iVersionIndex = LTE_ZTE_MICRO_B78;
        } 
        else
        {
            pstVersion->iVersionIndex = LTE_VER_IND_MAX;
    ...
    else if(NULL != (pcTmp = strstr(pcBuf, "+CGMR")))
    {
        sscanf(pcTmp, "+CGMR%s", acVersion);
        strncpy(pstVersion->acVersion, acVersion, sizeof(pstVersion->acVersion));
        if(NULL != strstr(acVersion, ZTE_B78_FLAG))
        {
            pstVersion->iVersionIndex = LTE_ZTE_MICRO_B78;
    ...
    else if(NULL != (pcTmp = strstr(pcBuf, acCiev2)))
    {
        sscanf(pcTmp, "%s", acVersion);
        strncpy(pstVersion->acVersion, acVersion, sizeof(pstVersion->acVersion));
        pstVersion->iVersionIndex = LTE_ZTE_MICRO_B78;
...
static LTE_RET_E zte_micro_b57_n_pin_input_remain(void *pvData, char *pcBuf)
{
    char    acTacTmp[32] = {0};
    int     iRet = 0;
    char    acCiev[32] = "+ZRAP:";
...
LTE_MODULE_OPS_T stLte_b57_ops_t = {
    .lte_pin_state_get       = zte_micro_b57_5_pin_state,
    .lte_pin_switch          = zte_micro_b57_5_pin_switch,    
    .lte_pin_switch_get      = zte_micro_b57_5_pin_sw_get,
    .lte_pin_unlock          = zte_micro_b57_5_pin_unlock,
    .lte_pin_attempts        = NULL,
    .lte_pin_code_alter      = zte_micro_b57_5_pin_alter,
    .lte_signal_get          = zte_micro_b57_5_signal_get,
    .lte_power_on            = zte_micro_b57_5_power_on,
    .lte_power_off           = zte_micro_b57_5_power_off,
    .lte_power_state_get     = NULL,
    .lte_net_type_set        = zte_micro_b57_5_nettype_set,
    .lte_net_type_get        = zte_micro_b57_5_nettype_get,
    .lte_plmn_register       = NULL,
    .lte_plmn_prefer_set     = NULL,
    .lte_net_work_prepare    = zte_micro_b57_5_network_prepare,
    .lte_net_work_status_get = zte_micro_b57_5_network_status_get,
    .lte_connect             = zte_micro_b57_5_connect,
    .lte_disconnect          = zte_micro_b57_5_disconnect,
    .lte_link_state_get      = zte_micro_b57_5_linkstate_get,
    .lte_imei_get            = zte_micro_b57_5_imei_get,
    .lte_cellid_get          = zte_micro_b57_5_cellid_get,
    .lte_iccid_get           = zte_micro_b57_5_iccid_get,
    .lte_imsi_get            = zte_micro_b57_5_imsi_get,
    .lte_sim_state_get       = zte_micro_b57_5_simstate_get,
    .lte_info_get            = zte_micro_b57_5_lte_info_get,
    .lte_access_net_get      = zte_micro_b57_5_access_net_get,
    .lte_bands_get           = zte_micro_b57_5_bands_get,
    .lte_clck_bands          = zte_micro_b57_5_clck_bands_set,
    .lte_clck_cell_get       = zte_micro_b57_5_clckcell_enable_get,
    .lte_clck_cell           = zte_micro_b57_5_clck_cellid_set,
    .lte_gps_start           = NULL, 
    .lte_gps_stop            = NULL,
    .lte_oper_info_get       = zte_micro_b57_5_oper_info_get,
    .lte_nettype_info_get    = zte_micro_b57_5_sup_nettype_get,
    .lte_sms_cent_code_set   = zte_micro_b57_5_sms_cent_code_set,
    .lte_sms_mode_set        = zte_micro_b57_5_sms_mode_set,
    .lte_sms_func_init       = zte_micro_b57_5_sms_func_init,
    .lte_sms_recv            = zte_micro_b57_5_sms_recv,
    .lte_sms_send            = zte_micro_b57_5_sms_send,
    .lte_sms_del             = zte_micro_b57_5_sms_dele,
    .lte_sms_supinfo_get     = zte_micro_b57_5_sms_sup_func,
    .lte_sms_ip_stack_set    = zte_micro_b57_5_cgdcont_set,
    .lte_apn_get             = NULL,
    .lte_apn_set             = zte_micro_b57_5_apn_set,
    .lte_version_get         = zte_micro_b57_n_ver_get,
    .lte_enodebid_get        = zte_micro_b57_n_enodeb_id_get,
    .lte_tac_get             = zte_micro_b57_n_tac_get,
    .lte_lcid_get            = zte_micro_b57_n_lcid_get,
    .lte_all_cellid_get      = zte_micro_b57_n_all_cellid_get,
    .lte_sim_unlock          = zte_micro_b57_n_sim_unlock,
    .lte_sim_disable_unlock  = zte_micro_b57_n_sim_disable_unlock,
    .lte_sim_type_get        = zte_micro_b57_n_sim_type_get,
    .lte_ip_gw_dns_get       = zte_micro_b57_5_ip_gw_dns_get,
    .lte_all_plmn_mode_get   = zte_micro_b57_n_all_plmn_mode_get,
    .lte_sounet_mode_set     = zte_micro_b57_n_sounet_mode_set,
    .lte_sim_puk_unlock		 = zte_micro_b57_n_puk_unlock,
    .lte_pin_input_remain    = zte_micro_b57_n_pin_input_remain,
};
