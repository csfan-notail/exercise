...
#include "qua_include/log.h"
#include "qua_include/bgp_vty.h"
#include "qua_include/vrf.h"

#define ZEBRA_VTYSH_PATH			"/tmp/run/quagga/zebra.vty"
#define RIP_VTYSH_PATH				"/tmp/run/quagga/ripd.vty"
#define RIPNG_VTYSH_PATH			"/tmp/run/quagga/ripngd.vty"
#define OSPF_VTYSH_PATH				"/tmp/run/quagga/ospfd.vty"
#define OSPF6_VTYSH_PATH			"/tmp/run/quagga/ospf6d.vty"
#define BGP_VTYSH_PATH				"/tmp/run/quagga/bgpd.vty"
#define ISIS_VTYSH_PATH				"/tmp/run/quagga/isisd.vty"
#define BABEL_VTYSH_PATH			"/tmp/run/quagga/babeld.vty"
#define PIM_VTYSH_PATH				"/tmp/run/quagga/pimd.vty"
