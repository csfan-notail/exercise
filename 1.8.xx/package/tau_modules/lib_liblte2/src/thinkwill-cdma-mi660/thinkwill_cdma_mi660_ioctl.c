...
/* 信可mi660 at指令口为USB3，Modem口(拨号专用)为USB1(待测) */
#define ATCOM "/dev/ttyUSB3"

static int g_network_prepare = 0;

static LTE_RET_E thinkwill_cdma_mi660_power_on (void *pvData, int iDataLen)
{
...
static LTE_RET_E thinkwill_cdma_mi660_power_off (void *pvData, int iDataLen)
{
...
static LTE_RET_E thinkwill_cdma_mi660_signal_get (void *pvData, int iDataLen)
{
...
static LTE_RET_E thinkwill_cdma_mi660_linkstate_get(void *pvData, int iDataLen)
{
	if(pvData == NULL)
		return LTE_FAIL;
...
static LTE_RET_E thinkwill_cdma_mi660_imei_get (void *pvData, int iDataLen)
{
    if (pvData == NULL)
		return LTE_FAIL;
...
static LTE_RET_E thinkwill_cdma_mi660_simstate_get(void *pvData, int iDataLen)
{
	if (pvData == NULL)
		return LTE_FAIL;
...
static LTE_RET_E thinkwill_cdma_mi660_imsi_get(void *pvData, int iDataLen)
{
    int  iRet = 0;
    FILE *pstFd = NULL;
    char acBuff[64];
...
static LTE_RET_E thinkwill_cdma_mi660_iccid_get(void *pvData, int iDataLen)
{
    unsigned int uiFlag = 0;
    int iRet = 0;
    char acCiev[] = "+ICCID:";
...
static LTE_RET_E thinkwill_cdma_mi660_network_prepare(void *pvData, int iDataLen)
{
...
static LTE_RET_E thinkwill_cdma_mi660_network_status_get(void *pvData, int iDataLen)
{
...
static LTE_RET_E thinkwill_cdma_mi660_connect(void *pvData, int iDataLen)
{
    /*走evdo 的拨号流程*/
    system_call("/usr/sbin/pppd call thinkwill_evdo 1>/tmp/ppp_state 2>/tmp/ppp_error &");

    g_network_prepare = 0;
    return LTE_OK;
}

static LTE_RET_E thinkwill_cdma_mi660_disconnect(void *pvData, int iDataLen)
...
static LTE_RET_E thinkwill_cdma_mi660_gps_start(void *pvData, int iDataLen)
{
...
static LTE_RET_E thinkwill_cdma_mi660_gps_stop(void *pvData, int iDataLen)
{
...
/* 从文件中获取gps信息 */
static LTE_RET_E thinkwill_cdma_mi660_gpsinfo_get(char *acGps)
{
    FILE *pfData;
    char acTmp[128] = "";
    int iLoop = 0;
...
static LTE_RET_E thinkwill_cdma_mi660_gpsinfo_analysis(char *acGps, LTE_GPS_INFO_T *pstLteGpsInfo)
{
...
static LTE_RET_E thinkwill_cdma_mi660_gps_date_get(void *pvData, int iDataLen)
{
    ...
    thinkwill_cdma_mi660_gpsinfo_get(acGpsInfo);
    thinkwill_cdma_mi660_gpsinfo_analysis(acGpsInfo, &stLteGpsInfo);
...
*****************************************************************************/
static LTE_RET_E thinkwill_cdma_mi660_gps_pstinfo_get(void *pvData, int iDataLen)
{
    char   acGpsInfo[512] = {0};
    LTE_GPS_INFO_T stLteGpsInfo = {0};
...
/*****************************************************************************
 函 数 名  : thinkwill_cdma_mi660_sup_nettype_get
 功能描述  : 获取支持的网络类型
 输入参数  : void *pvData  
             int iDataLen  
 输出参数  : 无
...
*****************************************************************************/
static LTE_RET_E thinkwill_cdma_mi660_sup_nettype_get(void *pvData, int iDataLen)
{
...
static LTE_RET_E thinkwill_cdma_mi660_sms_sup_func(void *pvData, int iDataLen)
{
    int flag = 0;
...
static LTE_RET_E thinkwill_cdma_mi660_version_get(void *pvData, int iDataLen)
{
    int iRet = 0;
    char acBuff[64] = {0};
    char acVersion[64] = {0};
    ...
    pstVersion->iVersionIndex = LTE_THINKWILL_MI660;
    
    return LTE_OK;
}

LTE_IOCTL_FUNC_T astthinkwillmi660Table[] = 
{    
    ...
    {LTE_SIGNAL_GET,        thinkwill_cdma_mi660_signal_get,           0,0,   "thinkwill_cdma_mi660_signal_get"       }, 
    {LTE_POWER_ON,          thinkwill_cdma_mi660_power_on,           0,0,     "thinkwill_cdma_mi660_power_on"       }, 
    {LTE_POWER_OFF,         thinkwill_cdma_mi660_power_off,           0,0,    "thinkwill_cdma_mi660_power_off"       }, 
    ...
    {LTE_NETWORK_PREPARE,   thinkwill_cdma_mi660_network_prepare,           0,0,    "thinkwill_cdma_mi660_network_prepare"       }, 
    {LTE_NETWORK_STATUS_GET,thinkwill_cdma_mi660_network_status_get,           0,0, "thinkwill_cdma_mi660_network_status_get"       },
    {LTE_CONNECT,           thinkwill_cdma_mi660_connect,           0,0,    "thinkwill_cdma_mi660_connect"       }, 
    {LTE_DISCONNECT,        thinkwill_cdma_mi660_disconnect,           0,0,    "thinkwill_cdma_mi660_disconnect"       }, 
    {LTE_LINKSTATE_GET,     thinkwill_cdma_mi660_linkstate_get,           0,0, "thinkwill_cdma_mi660_linkstate_get"       }, 
    {LTE_IMEI_GET,          thinkwill_cdma_mi660_imei_get,           0,0,    "thinkwill_cdma_mi660_iemi_get"       }, 
    {LTE_CELLID_GET,        NULL,           0,0,    NULL       }, 
    {LTE_ICCID_GET,         thinkwill_cdma_mi660_iccid_get,           0,0,   "thinkwill_cdma_mi660_iccid_get"       },
    {LTE_IMSI_GET,          thinkwill_cdma_mi660_imsi_get,           0,0,    "thinkwill_cdma_mi660_imsi_get"       },
    {LTE_SIM_STATE_GET,     thinkwill_cdma_mi660_simstate_get,        0,0,   "thinkwill_cdma_mi660_simstate_get"       }, 
    ...
    {LTE_NETTYPE_INFO_GET,     thinkwill_cdma_mi660_sup_nettype_get,           0,0,    "thinkwill_cdma_mi660_sup_nettype_get"          },
    {LTE_GPS_START,         thinkwill_cdma_mi660_gps_start,           0,0,    "thinkwill_cdma_mi660_gps_start"       }, 
    {LTE_GPS_STOP,          thinkwill_cdma_mi660_gps_stop,            0,0,    "thinkwill_cdma_mi660_gps_stop"       }, 
    {LTE_GPS_DATE_GET,      thinkwill_cdma_mi660_gps_date_get,        0,0,    "thinkwill_cdma_mi660_gps_date_get"       }, 
    {LTE_GPS_POSITION_INFO_GET,  thinkwill_cdma_mi660_gps_pstinfo_get,           0,0,    "thinkwill_cdma_mi660_gps_pstinfo_get"       }, 
    ...
    {LTE_SMS_SUPP, thinkwill_cdma_mi660_sms_sup_func, 0, 0, "thinkwill_cdma_mi660_sms_sup_func"   },
    ...
    {LTE_VERSION_GET,       thinkwill_cdma_mi660_version_get,           0,0,    "thinkwill_cdma_mi660_version_get"       },
