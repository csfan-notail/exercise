...
#define LTEGPSINFO "/tmp/gps.info2"
#define LTEGPGGA   "/tmp/gps.gpgga2"
...
#define LTE_MODULE_VER_PATH     "/tmp/ltemodulever2"
...
#define LTE_SERVER_SOCKET_NAME "/var/run/ltecomsev2"
#define LTE_CLIENT_SOCKET_NAME "/var/run/lteclient2"

#define LTE_SMS_RECV_FILE       "/tmp/smsrecv2"

#define LTE_SMS_SEND_FILE       "/tmp/smssendfile2"
#define LTE_LCTCELLINFO_FILE       "/tmp/ltecellinfo2"
/*加密卡秘钥文件*/
#define LTE_SIM_SECRET_KEY_FILE    "/tmp/simsecretkey2"
