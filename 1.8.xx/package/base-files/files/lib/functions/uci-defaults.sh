...
#set network.lan._orig_ifname='$ifname'
#set network.lan._orig_bridge='true'
#set network.lan.ifname='eth0.4031 $ifname.4031'
#set network.lan2='interface'
#set network.lan2.type='bridge'
#set network.lan2.proto='static'
#set network.lan._orig_ifname='ath0'
#set network.lan2._orig_bridge='true'
#set network.lan2.ifname='$ifname $ifname.1'
#set network.lan2.ipaddr='172.16.0.1'
#set network.lan2.netmask='255.255.0.0'
set network.lan='interface'
set network.lan.type='bridge'
set network.lan.ifname='$ifname $ifname.1'
set network.lan._orig_ifname='$ifname'
set network.lan._orig_bridge='true'
