...
athr_mgmt_init(void)
{
#if defined (CONFIG_ATHRS17_PHY) || defined (CONFIG_ATHR_8033_PHY)
uint32_t rddata;
...
#ifdef CONFIG_ATHR_8033_PHY
			printf("AR8033 PHY init mac_unit[%d]\n", ath_gmac_macs[i]->mac_unit);
			athrs_ar8033_reg_init(NULL);
			printf("AR8033 Leaving init\n");
#endif
		} else {
