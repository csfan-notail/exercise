...
#define ATH_DDR_SIZE_INCR		(8 * 1024 * 1024)
...
/*2015.05.13 liyugao: Output Driver Impedance Control -- Full strength*/
#define CFG_DDR2_EXT_MODE_VAL1			0x780
#define CFG_DDR2_EXT_MODE_VAL2          0x400
#else
#define CFG_DDR2_EXT_MODE_VAL1			0x782
#define CFG_DDR2_EXT_MODE_VAL2          0x402
#endif
...
ath_ddr_initial_config(uint32_t refresh)
{
    ...
    prmsg("CFG_DDR2_EXT_MODE_VAL1 %#x CFG_DDR2_EXT_MODE_VAL2 %#x\n", 
        CFG_DDR2_EXT_MODE_VAL1, CFG_DDR2_EXT_MODE_VAL2);
