...
#priv include files path
export SYSTEM_TYPE=OPENWRT
export GW_INCLUDE=$(TOPDIR)/local/gateway/include
export GW_EXT_APP_INCLUDE=$(TOPDIR)/local/gateway/include/ext_app_include
export GW_EXT_NET_INCLUDE=$(TOPDIR)/local/gateway/include/ext_net_include
export GW_PAL_INCLUDE=$(TOPDIR)/local/gateway/include/pal_include

export TAU_INCLUDE=$(TOPDIR)/package/tau_modules/include
export TAU_LIBDIR=$(TARGET_DIR)/lib
export LTE_INCLUDE=$(TOPDIR)/package/tau_modules/lib_liblte/src/include
export LTE_INCLUDE2=$(TOPDIR)/package/tau_modules/lib_liblte2/src/include
