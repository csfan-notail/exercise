...
encode = s:taboption("general", ListValue, "encode", translate("Encode"))
encode.override_values = true
encode:value("UTF-8", translate("Encode UTF-8"))
encode:value("GB2312", translate("Encode GB2312"))
...
if hwtype == "atheros" or hwtype == "qcawifi" or hwtype == "mac80211" or hwtype == "prism2" then
	...
	-- Probe EAP support
	local has_ap_eap  = (os.execute("hostapd -veap >/dev/null 2>/dev/null") == 256)
