...
extern int nf_fw_access(fw_access_t type, const char *mac,t_client *client);
extern int nf_fw_access2(fw_access_t type, const char *mac);
extern char *arp_get(char *req_ip);
extern char *arp_get_ip(char *req_mac);
extern int fw_set_free_auth(void);
extern int fw_set_auth(void);

extern int fw_qos_init(void);
extern int fw_qos_reinit(void);
extern int fw_qos_add(const char *mac, const int upload, const int download);
