#ifndef __NVRAM_FLASH_H__
#define __NVRAM_FLASH_H__

//ºê¸ô¿ª16M flash by cj
#ifdef FLASH_16
/*  16M flash
...
mtd8: 00320000 00010000 "jffs2"
mtd9: 00010000 00010000 "ART"
*/
#define NVRAM_DATA_SIZE (0x0010000 - 4)
...
#define NVRAM_STAGING		"/tmp/.nvram_0101011000"
#define NVRAM_FLASH_MTD   "/dev/mtdblock6"
...
mtd1: 00010000 00010000 "u-boot-env"
mtd2: 00140000 00010000 "uImage"
mtd3: 00310000 00010000 "squashfs1"
mtd4: 00310000 00010000 "squashfs2"
mtd5: 00010000 00010000 "nvram"
mtd6: 00010000 00010000 "nvram-bak"
mtd7: 00020000 00010000 "reserved"
...
#define NVRAM_STAGING	        "/etc/.nvram"
#define NVRAM_FLASH_MTD         "/etc/nvram"
#else

#define NVRAM_STAGING	        "/tmp/.nvram_0101011000"
#if (defined(AP9341_OAM_21))
#define NVRAM_FLASH_MTD         "/dev/mtdblock5"
#else
#define NVRAM_FLASH_MTD         "/dev/mtdblock6"
#endif
...
#define USE_V_MUTEX_LOCK static unsigned long aulCrcTable[256] = {  \
...
extern int organization_ap93_config(void);
