 ...
 ******************************************************************************
  文 件 名   : nf_potal_ioctl_main.h
  版 本 号   : 初稿
  作    者   : Zhong Huaqing
  生成日期   : 2012年8月10日 星期五
  最近修改   :
  功能描述   : nf_potal_ioctl_main.c 的头文件
  函数列表   :
  修改历史   :
...
#ifndef __NF_PORTAL_IOCTL_MAIN_H__
#define __NF_PORTAL_IOCTL_MAIN_H__
...
#endif /* __NF_PORTAL_IOCTL_MAIN_H__ */
