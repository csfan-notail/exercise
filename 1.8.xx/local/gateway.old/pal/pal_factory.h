...
mtd6: 00020000 00010000 "reserved"
mtd7: 00010000 00010000 "factory"
mtd8: 00010000 00010000 "art"
mtd9: 00760000 00010000 "firmware
*/
...
#define NVRAM_STAGING		"/tmp/.nvram_01010110009"

#define NVRAM_FLASH_MTD         "/dev/mtdblock9"

#define NVRAM_NAME_MAX_LEN 128
#define NVRAM_VALUE_MAX_LEN 256

#define FACTORY_NAME_MAX_LEN NVRAM_NAME_MAX_LEN
#define FACTORY_VALUE_MAX_LEN NVRAM_VALUE_MAX_LEN
...
//#define DEBUG_NVRAM
#ifdef DEBUG_NVRAM
#define NVRAM_DEBUGF(fmt,args...) do {\
                            syslog(0,"%s()[line%d]", __FUNCTION__, __LINE__);\
                            syslog(0,fmt ,##args);}while(0)
#else
#define NVRAM_DEBUGF(fmt,args...)
#endif


static unsigned long aulCrcTable[256] = {
