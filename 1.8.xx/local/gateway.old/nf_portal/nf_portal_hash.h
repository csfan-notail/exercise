 ...
 * 宏定义                                       *
 *----------------------------------------------*/
#define NF_PORTAL_STA_HASH_SIZE    256
#define NF_PORTAL_DEST_IP_BAW_HLIST_SIZE 8 /*目的IP 黑白名单链表大小*/
#define NF_PORTAL_PORT_HLIST_SIZE 8 /*免认证端口表项大小*/
#define NF_PORTAL_MAC_BAW_HLIST_SIZE 8 /*MAC黑白名单链表大小*/
#define NF_PORTAL_USER_IP_BAW_HLIST_SIZE 8 /*用户IP 黑白名单链表表项大小*/
#define NF_PORTAL_PORT_NUM_HLIST_SIZE  8/*透传端口号表项大小*/
#define NF_PORTAL_URL_IP_BAW_HLIST_SIZE 256 /*URL对应的IP 黑白名单链表大小*/
...
NF_PORTAL_STA_ENTRY_T *nf_portal_get_sta_from_htable(UINT8 *pucMac,UINT32 uiIp);
