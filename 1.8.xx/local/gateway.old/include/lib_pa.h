...
extern  int portal_get_auth_state(unsigned char *pucMac,unsigned int uiIp,unsigned int *puiState);
extern  int portal_set_auth_state(unsigned char *pucMac,unsigned int uiIp,unsigned int uiState);
