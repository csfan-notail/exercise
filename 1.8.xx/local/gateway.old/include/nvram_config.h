...
#define NVRAM_BBLINK_WEBAUTH_SWTICH         GATEWAY"bblink_webauth_switch"
...
#define NVRAM_BBLINK_WEBAUTH_SWTICH         "bblink_webauth_switch"
...
/* Lan 口vlan配置 */
#if (defined(AP9341_OAM_21) || defined(AP9344_GW))
#define LAN_NUM                 2
...
#define NVRAM_AUTH_IDLE_TIMEOUT             "ap_idle_timeout"
#define NVRAM_AUTH_FORCE_TIMEOUT            "ap_force_timeout"
...
extern int ipv4_nvram_get(ipv4 *pst_ip);
...
extern int function_debug_nvram_set(authorize_control_t *t);
