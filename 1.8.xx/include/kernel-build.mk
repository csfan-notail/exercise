...
ifeq ($(strip $(CONFIG_EXTERNAL_KERNEL_TREE)),"")
  ...
  install: $(LINUX_DIR)/.image
	@echo "kernel compile and install *.ko files ..."
	#$(CP) $(LINUX_DIR)/drivers/usb/serial/usbserial.ko $(TARGET_DIR)/lib/modules/3.3.8
	$(CP) $(LINUX_DIR)/drivers/usb/serial/usb_wwan.ko $(TARGET_DIR)/lib/modules/3.3.8
	$(CP) $(LINUX_DIR)/drivers/usb/serial/option.ko $(TARGET_DIR)/lib/modules/3.3.8
	#$(CP) $(LINUX_DIR)/drivers/net/usb/usbnet.ko $(TARGET_DIR)/lib/modules/3.3.8
	#$(CP) $(LINUX_DIR)/drivers/net/usb/cdc_ncm.ko $(TARGET_DIR)/lib/modules/3.3.8
	$(CP) $(LINUX_DIR)/drivers/gpio/gpio-xra1403.ko $(TARGET_DIR)/lib/modules/3.3.8
	rm -rf $(TARGET_DIR)/lib/modules/3.3.8/umac.ko
