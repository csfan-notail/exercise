...
BUILD_TYPES += host
HOST_STAMP_PREFIX=$(subst /,_,$(patsubst /%,%,$(subst $(BUILD_DIR_HOST),,$(HOST_BUILD_DIR))))
HOST_STAMP_PREPARED=$(BUILD_DIR_HOST)/stamp/.$(HOST_STAMP_PREFIX)_prepared$(if $(HOST_QUILT)$(DUMP),,$(shell $(call find_md5,${CURDIR} $(PKG_FILE_DEPENDS),)))
HOST_STAMP_CONFIGURED:=$(BUILD_DIR_HOST)/stamp/.$(HOST_STAMP_PREFIX)_configured
HOST_STAMP_BUILT:=$(BUILD_DIR_HOST)/stamp/.$(HOST_STAMP_PREFIX)_built
